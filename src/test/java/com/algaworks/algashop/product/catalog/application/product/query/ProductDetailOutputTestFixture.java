...
public class ProductDetailOutputTestFixture {

    private ProductDetailOutputTestFixture() {
    }
    ...
    public static ProductDetailOutput.ProductDetailOutputBuilder aProductALt2() {
        return ProductDetailOutput.builder()
                .id(UUID.randomUUID())
                .addedAt(OffsetDateTime.now())
                .name("Notebook Avell")
                .brand("Deep Diver")
                .description("A Gamer Notebook")
                .regularPrice(new BigDecimal("1200.00"))
                .salePrice(new BigDecimal("1000.00"))
                .inStock(false)
                .enabled(true)
                .category(CategoryMinimalOutput.builder()
